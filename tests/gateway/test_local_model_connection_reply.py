"""Regression tests for #86570 and #116323: gateway provider error connection messaging."""
...
# An ESTABLISHED connection died mid-transfer. Whether the endpoint is up is unknowable from these
# (the same turn may already have been answered by it, cf. #26339).
...
class TestGatewayConnectionErrorReply:
    ...
    @pytest.mark.parametrize("platform", ["telegram", "slack", "feishu"])
