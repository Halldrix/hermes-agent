...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("curator", "Background skill maintenance (status, run, pin, archive, promote)",
               "Tools & Skills", args_hint="[subcommand]",
               subcommands=("status", "run", "pause", "resume", "pin", "unpin", "restore", "list-archived", "promote")),
