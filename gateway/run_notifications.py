"""Process/completion notifications, media delivery and async-delegation delivery for GatewayRunner.
...
from gateway.run_notifications_update import GatewayUpdateNotificationsMixin
...
class GatewayNotificationsMixin(GatewayUpdateNotificationsMixin):
    """Process/completion notifications, media delivery and async-delegation delivery for GatewayRunner.

    The /update watcher lives in the topical ``run_notifications_update`` sibling.
    """
